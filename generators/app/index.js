...
module.exports = class extends BaseGenerator {
    ...
    get end() {
        return {
            ...
            // INICIO [MPRO] (CODIGO INCLUIDO => EXECUTA O comando <generator-jhipster-entity-audit> PARA ATIVAR A AUDITORIA DAS ENTIDADES CRIADAS)
            ativarAuditoria(){
                this.spawnCommandSync('yo jhipster-entity-audit', []); 
            }
            // FIM [MPRO] 
        };
    }
