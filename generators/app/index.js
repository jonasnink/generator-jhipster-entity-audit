  ...
  get writing() {
    return {
      ...
      writeAuditPageFiles() {
        ...
        // add new menu entry
        this.addElementToAdminMenu('admin/entity-audit', 'bell', this.enableTranslation, this.clientFramework);
        if (this.enableTranslation) {
          this.languages.forEach((language) => {
            ...
            this.addAdminElementTranslationKey('admin/entity-audit', menuText, language);
          });
        }
      },
