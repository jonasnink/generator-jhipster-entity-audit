        ...
        writeEnumFiles() {
            this.fields.forEach(field => {
                if (field.fieldIsEnum === true) {
                    // INICIO [MPRO] (CODIGO ALTERADO => VERIFICA SE O ARQUIVO i18n/pt-br/enum.json JÁ EXISTE, CASO SIM NÃO SOBRESCREVE, CASO NÃO CRIA O ARQUIVO.)
                    if(!fs.existsSync(`${CLIENT_MAIN_SRC_DIR}i18n/pt-br/${field.fieldType}.json`)){
