...
module.exports = class extends PrivateBase {
    ...
    printJHipsterLogo() {
        ...
        // INICIO [MPRO] (CODIGO ALTERADO => Incluído informação de que a Versão foi Customizada.)
        this.log(chalk.white('Bem vindo ao JHipster ') + chalk.yellow(`v${packagejs.version}`) + chalk.bold.green(' (VERSÃO CUSTOMIZADA - MINISTÉRIO PÚBLICO DO ESTADO DE RONDÔNIA - MPRO)'));
        // FIM [MPRO]  
